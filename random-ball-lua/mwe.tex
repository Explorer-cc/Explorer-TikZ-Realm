...
\begin{tikzpicture}
    \directlua{
        physics.draw_packed_balls(50, 0.1,
...
\begin{tikzpicture}
    \directlua{
        physics.draw_packed_balls(
            30,0.15,
            physics.trapezoid_walls({-3, -1}, {-1, -3}, {1, -2}, {1, 0}),
            {
                seed = 42,
                ball_style = "draw=magenta, fill=magenta!45",
                wall_style = "very thick, draw=teal!70, line cap=rect",
                highlight_style = "fill=white, opacity=0.55",
            }
        )
    }
