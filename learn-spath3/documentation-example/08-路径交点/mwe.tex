...
\usetikzlibrary{spath3,arrows.meta,intersections,patterns}
\begin{document}
\begin{tikzpicture}
    \draw[spath/save global=pathA] (0,0) 
    to[out=0,in=180] ++(2,1)
    to[out=0,in=180] ++(2,-1) 
    to[out=0,in=180] ++(2,1) 
    to[out=0,in=180] ++(2,-1);
    \draw[spath/save global=pathB] (0,1) 
    to[out=0,in=180] ++(2,-1)
    to[out=0,in=180] ++(2,1) 
    to[out=0,in=180] ++(2,-1) 
    to[out=0,in=180] ++(2,1);
...
\begin{tikzpicture} 
    \tikzset{
        spath/.cd,split at intersections={pathA}{pathB},
