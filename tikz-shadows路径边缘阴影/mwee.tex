% https://tex.stackexchange.com/a/762464
\documentclass[tikz,border=5pt]{standalone}
\usetikzlibrary{spy}
\begin{document}
\begin{tikzpicture}[
        spy using outlines={circle, magnification=3, size=3cm,connect spies},
  ...
  \draw[
    ...
    \spy[red] on (140:2) in node at (-2,-2);
    \spy[blue] on (40:2) in node at (+2,-2);
\end{tikzpicture}
\end{document}
